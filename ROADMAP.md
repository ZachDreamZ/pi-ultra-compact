...
| 5.2 | `[P1]` | All Phase 3 test coverage at 85%+ | Phase 3 | `[x]` |
| 5.3 | `[P1]` | All Phase 4 documentation complete | Phase 4 | `[x]` |
| 5.4 | `[P2]` | Bump to v1.0.0 with full changelog | 5.1-5.3 | `[x]` |
| 5.5 | `[P2]` | Write migration guide from v0.x to v1.0 | 5.4 | `[x]` |
