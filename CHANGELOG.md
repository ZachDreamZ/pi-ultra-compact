...
- **TypeScript upgraded from 5.9.3 to 6.0.3** — major version bump. Added `"types": ["node"]` to tsconfig.json to satisfy TS 6.0's stricter global type resolution for `console` and other Node.js globals.
- **All 337 tests pass** under TypeScript 6.0.3 with zero type errors.

### Security

- **No new vulnerabilities** — npm audit reports 0 vulnerabilities after upgrade.
